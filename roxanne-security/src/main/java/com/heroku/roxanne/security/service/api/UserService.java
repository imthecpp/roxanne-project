...
public interface UserService {
    ...
    UserIdentity update(Long id, UserEntity userEntity) throws UserNotExistException;
    UserIdentity create(UserEntity userEntity) throws UserAlreadyExistException;
